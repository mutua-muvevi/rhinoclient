...
export const serviceBannerInfo = {
	...
	subTitle: "",
	paragraph: [
		`Kenya being the center hub of Africa with several connections to the rest of the world through accessible entry and exit points by air, sea and road, the existing infrastructures contribute to put Kenya as the busiest transit point handling consignments from a multitude of origins to a multiple of destinations across the world.`,
		`We offer transport, logistics and customs clearance/handling services for local and international shipments providing full logistics activities of shipping, storage and security of consignment. We are operational in Kenya, with offices in big cities of Nairobi, Mombasa, Nakuru, Kisumu, Eldoret and in the main borders of Namanga, Busia and Malaba.`
	],
	image: {
