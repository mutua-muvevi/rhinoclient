...
const StorageQuotation = ({quotation, error}) => {
	...
	return (
		<StyledDataGridContainer>
			<StyledDataGridHeader title="Storage Quotation" />
			<StyledDataGrid
				rows={quotation}
				columns={columns}
				autoPageSize
...
export default StorageQuotation